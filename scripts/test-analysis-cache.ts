...
async function run() {
  ...
  db.run("CREATE TABLE IF NOT EXISTS lineage_statements (project_id TEXT NOT NULL, file_path TEXT NOT NULL, statement_index INTEGER NOT NULL, statement_type TEXT NOT NULL, source_name TEXT, sql_text TEXT, join_count INTEGER NOT NULL DEFAULT 0, complexity_score INTEGER NOT NULL DEFAULT 0, updated_at INTEGER NOT NULL, PRIMARY KEY (project_id, file_path, statement_index))");
  db.run("CREATE TABLE IF NOT EXISTS lineage_nodes (project_id TEXT NOT NULL, file_path TEXT NOT NULL, node_id TEXT NOT NULL, node_type TEXT NOT NULL, label TEXT NOT NULL, qualified_name TEXT, statement_index INTEGER NOT NULL, resolution_source TEXT, PRIMARY KEY (project_id, file_path, node_id))");
  db.run("CREATE TABLE IF NOT EXISTS lineage_columns (project_id TEXT NOT NULL, file_path TEXT NOT NULL, column_id TEXT NOT NULL, label TEXT NOT NULL, qualified_name TEXT, parent_node_id TEXT, expression TEXT, statement_index INTEGER NOT NULL, PRIMARY KEY (project_id, file_path, column_id))");
  db.run("CREATE TABLE IF NOT EXISTS lineage_edges (project_id TEXT NOT NULL, file_path TEXT NOT NULL, edge_id TEXT NOT NULL, from_id TEXT NOT NULL, to_id TEXT NOT NULL, edge_type TEXT NOT NULL, expression TEXT, statement_index INTEGER, PRIMARY KEY (project_id, file_path, edge_id))");
  db.run("CREATE TABLE IF NOT EXISTS lineage_table_flows (project_id TEXT NOT NULL, file_path TEXT NOT NULL, source_table TEXT NOT NULL, target_table TEXT NOT NULL, PRIMARY KEY (project_id, file_path, source_table, target_table))");
    ...
    statements: [
      {
        ...
        sourceName: 'a.sql',
        nodes: [ { id: 'n1', type: 'table', label: 'db.table1', qualifiedName: 'db.table1', resolutionSource: 'mock' } ],
        edges: [],
        joinCount: 0,
        complexityScore: 0,
      }
    ],
    resolvedSchema: { tables: [ { name: 'table1', schema: 'db', temporary: false, columns: [ { name: 'col1' } ] } ] },
    globalLineage: { nodes: [], edges: [] },
    issues: [],
    summary: { statementCount: 1, tableCount: 1, columnCount: 1, joinCount: 0, complexityScore: 0, issueCount: { errors: 0, warnings: 0, infos: 0 }, hasErrors: false }
  };
