...
export const BINARY_EXTENSIONS = new Set([
  ...
  '.zip', '.gz', '.tar', '.tgz', '.rar', '.7z', '.exe', '.dll', '.so', '.dylib',
  '.class', '.jar', '.war', '.pyc', '.o', '.a', '.wasm', '.mp3', '.mp4', '.mov',
  '.avi', '.webm', '.ogg', '.wav', '.flac', '.ttf', '.otf', '.woff', '.woff2',
  '.eot', '.db', '.sqlite', '.sqlite3', '.lock', '.bin', '.dat', '.ds_store',
]);
