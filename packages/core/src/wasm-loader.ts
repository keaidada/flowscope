let wasmModule: typeof import('./wasm/capybara_wasm') | null = null;
let initPromise: Promise<typeof import('./wasm/capybara_wasm')> | null = null;
...
export async function initWasm(
...
): Promise<typeof import('./wasm/capybara_wasm')> {
  ...
  initPromise = (async () => {
    try {
      ...
      const wasm = await import('./wasm/capybara_wasm');
 ...
 */
export function getWasmModule(): typeof import('./wasm/capybara_wasm') {
  if (!wasmModule) {
