...
//!
//! This module defines the request and response types for the Capybara analysis API.
...
pub use common::{
    ...
    IssuePatchEdit, LineageEntry, LintConfidence, LintEngine, LintFallbackSource, Severity, Span,
    Summary,
};
pub use completion::{
