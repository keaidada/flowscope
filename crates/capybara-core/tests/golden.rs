use capybara_core::{analyze, AnalyzeRequest, Dialect, FileSource};
...
fn golden_resolved_schema_with_imported_and_implied() {
    use capybara_core::{ColumnSchema, SchemaMetadata, SchemaTable};
...
fn imported_schema_resolves_via_default_schema() {
    use capybara_core::{AnalyzeRequest, ColumnSchema, Dialect, SchemaMetadata, SchemaTable};
