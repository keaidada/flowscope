//! Build script for capybara-core.
//!
...
fn run() -> Result<(), Box<dyn Error>> {
    ...
    if !spec_dir.exists() {
        return Err(format!(
            "Spec directory not found at {:?}. Expected at crates/capybara-core/specs/dialect-semantics/",
...
impl NormalizationStrategy {
    ...
    /// ```
    /// use std::borrow::Cow;
    /// use capybara_core::generated::NormalizationStrategy;
    ///
...
///
/// ```ignore
/// use capybara_core::generated::is_value_table_function;
/// use capybara_core::Dialect;
///
...
///
/// ```ignore
/// use capybara_core::generated::infer_function_return_type;
///
...
///
/// ```ignore
/// use capybara_core::generated::normalize_type_name;
/// use capybara_core::generated::CanonicalType;
///
...
///
/// ```ignore
/// use capybara_core::generated::{can_implicitly_cast, CanonicalType};
///
...
///
/// ```ignore
/// use capybara_core::generated::{dialect_type_name, CanonicalType};
/// use capybara_core::Dialect;
///
