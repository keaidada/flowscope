...
fn severity_class(severity: capybara_core::Severity) -> &'static str {
    match severity {
        capybara_core::Severity::Error => "error",
        capybara_core::Severity::Warning => "warning",
        capybara_core::Severity::Info => "info",
    }
}

fn severity_label(severity: capybara_core::Severity) -> &'static str {
    match severity {
        capybara_core::Severity::Error => "ERROR",
        capybara_core::Severity::Warning => "WARNING",
        capybara_core::Severity::Info => "INFO",
