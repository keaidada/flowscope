...
use capybara_core::{AnalyzeResult, EdgeType, NodeType};
...
pub fn extract_lineage_entries(result: &AnalyzeResult) -> Vec<LineageEntry> {
    ...
    fn is_physical(node: &capybara_core::Node) -> bool {
...
mod tests {
    ...
    use capybara_core::{AnalyzeResult, Edge, Node, StatementLineage};
