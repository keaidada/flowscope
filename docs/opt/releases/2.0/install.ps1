# Capybara v2.0 - Windows PowerShell Installer
# Run: powershell -ExecutionPolicy Bypass -File install.ps1

$ErrorActionPreference = "Stop"

Write-Host "============================================" -ForegroundColor Cyan
Write-Host "  Capybara v2.0 - Windows Installer" -ForegroundColor Cyan
Write-Host "============================================" -ForegroundColor Cyan
Write-Host ""
...
if (Test-Path $sourceExe) {
    ...
    Write-Host "       Download from: https://github.com/keaidada/capybara/releases/tag/v2.0"
}
