...
title Capybara v2.0 Installer

echo ============================================
echo   Capybara v2.0 - Windows Installer
echo ============================================
echo.
...
if exist "%~dp0capybara.exe" (
    ...
    echo        https://github.com/keaidada/capybara/releases/tag/v2.0
